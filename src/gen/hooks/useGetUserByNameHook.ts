 ...
 * @link /user/:username
 */
export function useGetUserByNameHook<TData = GetUserByName["response"], TQueryData = GetUserByName["response"], TQueryKey extends QueryKey = GetUserByNameQueryKey>(username: GetUserByNamePathParams["username"], options: {
...
export const getUserByNameInfiniteQueryKey = (username: GetUserByNamePathParams["username"]) => [{ url: "/user/:username", params: { username: username } }] as const;
 ...
 * @link /user/:username
 */
export function useGetUserByNameHookInfinite<TData = InfiniteData<GetUserByName["response"]>, TQueryData = GetUserByName["response"], TQueryKey extends QueryKey = GetUserByNameInfiniteQueryKey>(username: GetUserByNamePathParams["username"], options: {
 ...
 * @link /user/:username
 */
export function useGetUserByNameHookSuspense<TData = GetUserByName["response"], TQueryKey extends QueryKey = GetUserByNameSuspenseQueryKey>(username: GetUserByNamePathParams["username"], options: {
