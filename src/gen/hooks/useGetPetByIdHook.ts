 ...
 * @link /pet/:petId
 */
export function useGetPetByIdHook<TData = GetPetById["response"], TQueryData = GetPetById["response"], TQueryKey extends QueryKey = GetPetByIdQueryKey>(petId: GetPetByIdPathParams["petId"], options: {
 ...
 * @link /pet/:petId
 */
export function useGetPetByIdHookInfinite<TData = InfiniteData<GetPetById["response"]>, TQueryData = GetPetById["response"], TQueryKey extends QueryKey = GetPetByIdInfiniteQueryKey>(petId: GetPetByIdPathParams["petId"], options: {
 ...
 * @link /pet/:petId
 */
export function useGetPetByIdHookSuspense<TData = GetPetById["response"], TQueryKey extends QueryKey = GetPetByIdSuspenseQueryKey>(petId: GetPetByIdPathParams["petId"], options: {
